...
//                     <span>
//                         {toggleSave ? <AiFillHeart className='contentWraper-nav__icon' onClick={handleToggleSave} color='red' />
//                             :
//                             <AiOutlineHeart className='contentWraper-nav__icon' onClick={handleToggleSave} />
//                         }
//                     </span>
//                     <span>
...
//                                         <ImageGallery startIndex={selectIndexImage} slideToIndex={selectIndexImage} items={carosel} />
//                                     </Col>
//                                     :
//                                     <Col style={{ height: '100%' }} span={18}>
