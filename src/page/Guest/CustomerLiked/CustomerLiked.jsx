...
import { Avatar, Card, Col, Divider, List, Popconfirm, Row, Space, Tooltip, message } from 'antd';
import React, { useState } from 'react';
import { FaBed, FaHotel } from 'react-icons/fa';
import { Link } from 'react-router-dom';
import { iconHotel } from '../../../asset/svg';
import './CustomerLiked.scss';
...
//         'Nhà hàng Khách sạn Corvin có sức chứa 200 khách với nhiều món ăn Á Âu và các món đặc sản ven biển.',
//     content:
//         'Khách sạn Corvin gồm 56 phòng ngủ được xây dựng theo phong cách pha trộn Á Âu, được trang bị các tiện nghi: điều hoà nhiệt độ, bồn tắm, vòi hoa sen tắm nóng và lạnh, tủ lạnh, truyền hình cáp, Wifi Khách sạn Corvin gồm 56 phòng ngủ được xây dựng theo phong cách pha trộn Á Âu, được trang bị các tiện nghi: điều hoà nhiệt độ, bồn tắm, vòi hoa sen tắm nóng và lạnh, tủ lạnh, truyền hình cáp, Wifi Khách sạn Corvin gồm 56 phòng ngủ được xây dựng theo phong cách pha trộn Á Âu, được trang bị các tiện nghi: điều hoà nhiệt độ, bồn tắm, vòi hoa sen tắm nóng và lạnh, tủ lạnh, truyền hình cáp, Wifi Khách sạn Corvin gồm 56 phòng ngủ được xây dựng theo phong cách pha trộn Á Âu, được trang bị các tiện nghi: điều hoà nhiệt độ, bồn tắm, vòi hoa sen tắm nóng và lạnh, tủ lạnh, truyền hình cáp, Wifi Khách sạn Corvin gồm 56 phòng ngủ được xây dựng theo phong cách pha trộn Á Âu, được trang bị các tiện nghi: điều hoà nhiệt độ, bồn tắm, vòi hoa sen tắm nóng và lạnh, tủ lạnh, truyền hình cáp, Wifi Khách sạn Corvin gồm 56 phòng ngủ được xây dựng theo phong cách pha trộn Á Âu, được trang bị các tiện nghi: điều hoà nhiệt độ, bồn tắm, vòi hoa sen tắm nóng và lạnh, tủ lạnh, truyền hình cáp, Wifi Khách sạn Corvin gồm 56 phòng ngủ được xây dựng theo phong cách pha trộn Á Âu, được trang bị các tiện nghi: điều hoà nhiệt độ, bồn tắm, vòi hoa sen tắm nóng và lạnh, tủ lạnh, truyền hình cáp, Wifi',
// }));

const { Meta } = Card;
const CustomerLiked = () => {
    // const [loadMord, setLoadMore] = useState(5);
    ...
    console.log('likedRoom: ', likedRoom);
    ...
    const handleToggleLiked = (item) => {
        ...
        if (liked[item.key]) {
            message.success(`Đã thích ${item.title} `);
        } else {
            message.success(`Đã bỏ thích ${item.title} `);
        }
    };

    const handleToggleLikedRoom = (i) => {
        setLikedRoom((prevState) => ({
            ...prevState,
            [i]: !prevState[i],
        }));
        if (likedRoom[i]) {
    ...
    return (
        <>
            <div className="viewed-hotel">
                <h2 style={{ marginBottom: '12px' }}>Khách sạn đã thích</h2>
                <List
                    bordered
                    itemLayout="vertical"
                    size="large"
                    ...
                    renderItem={(item) => (
                        <List.Item
                            ...
                            actions={[
                                // <Popconfirm
                                //     title={`Bỏ thích ${item.title}`}
                                //     description="Bạn đã chắc chắn chứ?"
                                //     onConfirm={() => handleToggleLiked(item)}
                                //     // onCancel={cancel}
                                //     okText="Bỏ thích"
                                //     cancelText="Hủy"
                                // >
                                <Space className="icon" onClick={() => handleToggleLiked(item)}>
                                    {!liked[item.key] ? (
                                        <>
                        ...
                        >
                            ...
                            />
                            <div className="list__item-content">{item.content}</div>
                        </List.Item>
                    )}
                />
            </div>
            ...
            <div className="viewed__room">
                <h2 style={{ marginBottom: '12px' }}>Phòng đã thích</h2>
                <Row gutter={16}>
                    {dataRoom.map((item, i) => (
                                                ...
                                                <Col span={24}>
                                                    <div className="viewed__room-card__main">
                                                        <img
                                                            ...
                                                            src={image}
                                                        />
                                                        <Tooltip title={'Chọn để bỏ thích'}>
                                                            <span
                                                                className="viewed__room-card__main-liked"
                                                                onClick={() => handleToggleLikedRoom(i)}
                                                            >
                                                                {!likedRoom[i] ? (
                                                                    <HeartFilled
                                                                        style={{
